...
% ------------------------------------------------------------------
    ...
    \input{Topicos/Diagrama-Entidade-Relacionamento}
...
\medskip
    ...
    \input{Topicos/Diario-de-Bordo}

% --- Pesquisa de Campo ---
\section{Pesquisa de Campo}
\medskip
    \label{sect:Pesquisa-de-Campo}
    \input{Topicos/Pesquisa-de-Campo}

% --- Análise Swot ---
\section{Análise Swot}
\medskip
    \label{sect:Analise-Swot}
    \input{Topicos/Analise-Swot}
