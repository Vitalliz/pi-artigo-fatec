...
% Template cabeçalho FATEC (mais colado na linha)
\newcommand{\fatecCabecalho}[1][0cm]{%
    \newcommand{\LogoWidth}{0.23\textwidth}%
    \newcommand{\Gutter}{1em}%

    \noindent
    \begin{minipage}[c]{\LogoWidth}
        % se a logo tiver “respiro” em cima, corte um pouco:
        \includegraphics[height=4.5cm]{Logos/fatec.jpg}%
    \end{minipage}\hspace*{\Gutter}%
    \begin{minipage}[c]{\dimexpr\textwidth-\LogoWidth-\Gutter\relax}
        \raggedright\small
