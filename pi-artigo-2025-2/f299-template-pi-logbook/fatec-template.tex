...
\begin{longtable}{|m{4cm}|m{2.8cm}|m{2.8cm}|m{4.8cm}|m{8cm}|} % Usando 'm' para centralizar verticalmente
    ...
    \centering Prototipação no Figma & \centering 26/09/2025 & \centering & \centering Amanda & Criação de Wireframe e Wireflows do projeto. Atualizações nas telas na adição de tela de cadastro e inclusão de tutorial no protótipo da aplicação. \\ \hline
