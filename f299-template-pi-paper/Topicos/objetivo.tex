...
%1 - Desenvolver um sistema de visão computacional para identificar sintomas de deficiências nutricionais em imagens de folhas de mexericas.
%2 - Criar a funcionalidade de analisar a folha da mexerica apontando a câmera do celular para ela e deixar a IA  verificar o estado da planta.
%3 -  
%4 - Realizar uma análise de precisão do sistema desenvolvido em comparação com análises tradicionais de solo e folhas.
%5 - Fornecer recomendações práticas e úteis baseadas nos resultados obtidos, permitindo que os agricultores tratem as deficiências, quando necessário.