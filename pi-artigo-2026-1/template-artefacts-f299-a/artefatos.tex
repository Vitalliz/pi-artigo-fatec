...
% TESTEEEEEEEEEEE TIRAR DEPOIS
\begin{figure}[H]
\centering
\begin{minipage}{0.45\textwidth}
    \centering
    \fbox{\includegraphics[width=0.9\textwidth]{imgs/img_001.jpg}}
...
\begin{minipage}{0.45\textwidth}
    \centering
    \fbox{\includegraphics[width=0.9\textwidth]{imgs/Mockup Alta Fidelidade.png}}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.8\textwidth]{imgs/TelaInicio.png}
\caption{Protótipo da Dashboard Principal}
\label{fig:prototype-dashboard}
\end{figure}

Esta tela de início centraliza o monitoramento da propriedade ao exibir o progresso
da cobertura das análises, gráficos de evolução e distribuição de deficiências 
nutricionais, e um atalho para o escaneamento de imagens de folhas.

\begin{figure}[H]
\centering
\includegraphics[width=0.8\textwidth]{imgs/TelaHistorico-1.png}
\caption{Protótipo da Tela de Histórico}
...
\centering
\includegraphics[width=0.8\textwidth]{imgs/TelaHistorico-1.png}
\caption{Protótipo da Tela de Mapa}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.5\textwidth]{imgs/MobileLogin.png}
\caption{Protótipo da Tela de Login}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.5\textwidth]{imgs/MobileInicio.png}
\caption{Protótipo da Dashboard Principal}
\label{fig:prototype-dashboard}
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.5\textwidth]{imgs/MobileHistorico.png}
\caption{Protótipo da Tela de Histórico}
\label{fig:interface-mobile-tela-historico}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=0.5\textwidth]{imgs/MobileResultado.png}
\caption{Protótipo da Tela de Resultados}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.5\textwidth]{imgs/MobileMapa.png}
\caption{Protótipo da Tela de Mapa}
...
\hline
Primária & \colorbox[HTML]{58B741}{\phantom{AAA}} & \#58B741 & Botões principais \\
Secundária & \colorbox[HTML]{FF9E00}{\phantom{AAA}} & \#FF9E00 & Elementos secundários, destaques \\
Fundo & \colorbox[HTML]{FAF1E5}{\phantom{AAA}} & \#FAF1E5 & Background padrão \\
Texto & \colorbox[HTML]{000000}{\color{white}\phantom{AAA}} & \#000000 & Texto principal \\
Sucesso & \colorbox[HTML]{34C759}{\phantom{AAA}} & \#34C759 & Mensagens de sucesso \\
Erro & \colorbox[HTML]{E91F23}{\color{white}\phantom{AAA}} & \#E91F23 & Mensagens de erro \\
\hline
\end{tabular}
\end{table}
...
\node {Home}
    child {node {Sobre}
        child {node {Participações}}
    }
    child {node {Projetos}
        child {node {Projeto em Destaque}}
        child {node {Links}}
    }
    child {node {Equipe}
        child {node {Contato}}
...
\begin{itemize}
    \item \textbf{Home:} Apresentação da marca Vitalliz
    \item \textbf{Sobre:} História da equipe, missão, visão e valores
    \item \textbf{Projeto em Destaque:} Showcase do projeto desenvolvido com descrições e imagens
